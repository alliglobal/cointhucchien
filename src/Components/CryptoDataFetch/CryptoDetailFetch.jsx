...
export function CryptoDetailFetch({cryptoID}) {
    ...
    //Ex: https://api.coingecko.com/api/v3/coins/ethereum?localization=false&tickers=true&market_data=true&community_data=true&developer_data=true&sparkline=true
    useEffect(() => {
